define(['app', 'marionette', 'jquery-ui/jquery-ui',
    ...
    function(Framework, Marionette, ui, MainMenu, Class, Package, Component, Sequence) {
        ...
        var collectionView = Marionette.CollectionView.extend({
            ...
            addMenu: function(model, data) {
                ...
                this.elements = new elementsCollection({
                    collection: new Backbone.Collection(data.elements)
                });
                this.connectors = new connectorsCollection({
                    collection: new Backbone.Collection(data.connectors)
                });
            ...
            hasMenu: function(model) {
                var response = this.collection.where({
                    type: model.type
                });
        ...
        var ContentView = Marionette.LayoutView.extend({
            ...
            onRender: function() {
                this.accordion = new collectionView({
