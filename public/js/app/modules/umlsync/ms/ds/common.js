    ...
    (function($, dm, undefined) {
        ...
        dm.ms.ctx['common'] = function(menuBuilder, options, actions) {
            ...
            this['show'] = function(element, x, y) {
                ...
                var $ttt = $(ttt);
                $ttt.css({
                    "left": x - pz.left + scrollLeft,
                    "top": y - pz.top + scrollTop
                }).show();
        ...
        dm.ms.IconMenuBuilder = function(menus_loaded) {
            ...
            function getInstance() {
                ...
                if (!dm.dm['IconMenuBuilder']) {
                    ...
                    // Class diagram
                    mapping_icons["class"] = {
                        icon_menu: "us-class-menu"
                    };
                    mapping_icons["note"]["class"] = {
                        icon_menu: "us-class-note-menu"
                    };
                    //Package diagram
                    mapping_icons["package"] = {
                        icon_menu: "us-package-menu"
                    };
                    mapping_icons["note"]["package"] = {
                        icon_menu: "us-package-note-menu"
                    };
                    // Component diagram
                    mapping_icons["component"] = {
                        icon_menu: "us-component-menu"
                    };
                    mapping_icons["interface"] = {
                        icon_menu: "us-component-menu"
                    };
                    mapping_icons["port"] = {
                        icon_menu: "us-component-menu"
                    ...
                    mapping_icons["note"]["component"] = {
                        icon_menu: "us-component-note-menu"
                    };
                    // Sequence diagram
                    mapping_icons["objinstance"] = {
                        icon_menu: "us-objinstance-menu"
                    };
                    mapping_icons["llport"] = {
                        icon_menu: "us-objinstance-menu"
                    };
                    mapping_icons["lldel"] = {
                        icon_menu: "us-objinstance-menu"
                    ...
                    mapping_icons["note"]["sequence"] = {
                        icon_menu: "us-sequence-note-menu"
                    };
            ...
            IconMenuBuilder.prototype = {
                    ...
                    $("#tabs .elmenu-" + menu_id + " img").draggable({
                            ...
                            'start': function(event) {
                                if (iconMenuBuilder.diagram) {
                                    ...
                                    //			} else {
                                    iconMenuBuilder.diagram.Connector(this.id, {
                                        'fromId': iconMenuBuilder.currentElement,
                            ...
                            'stop': function(event, ui) {
                                ...
                                var tid = $(this).attr("aux"),
                                    element = {
                                        type: tid
                                    }, //$.extend({}, iconMenuBuilder.dmb.getElementById(tid)),
                                    lcon = this.id; //iconMenuBuilder.dmb.getConnectorById(this.id);
                ...
                Show: function(element, x, y) {
                    ...
                    if (this.currentElement == element.euid) {
                        ...
                        $(".elmenu-" + menu_id).stop().css("left", x).css("top", y - 20).animate({
                            opacity: "1"
                        });
                    }
                },
                ...
                Hide: function(element) {
                    if (this.currentElement == element.euid)
                        $(".elmenu-" + this.currentMenu).stop().animate({
                            opacity: "0"
                        });
                }
            };
