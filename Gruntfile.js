module.exports = function(grunt) {
    ...
    images: {
        expand:     true,
        cwd:        config.staticSrc.img,
        src:        ['**/*'],
        dest:       config.staticDist.img,
        filter:     'isFile',
        flatten:    false
    }
    		},
    ...
    grunt.registerTask('clean', 'Remove all bundles and tmp files', function() {
        ...
        files.push(config.staticDist.img);
    ...
    // Default task(s).
    grunt.registerTask('default', ['clean', 'less', 'cssmin', 'copy', 'autoprefixer', 'requirejs', 'jst', 'uglify', 'index']);
